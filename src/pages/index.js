...
function NavBar() {
  return (
    <nav className="bg-neutral-950 p-4 shadow-md">
      <div className="container mx-auto flex justify-center">
        <h1 className="text-2xl text-white font-bold">Capture Code</h1>
      </div>
    </nav>
  );
}
export default function Home() {
  ...
  return (
    ...
    <p className=" bg-neutral-800 color : text-white" >@khankor</p>
    </>
  );
}
